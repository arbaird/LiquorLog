...
import static com.austinbaird.liquorlog.R.id.editName1;
import static com.austinbaird.liquorlog.R.id.messageEnter;
import static com.austinbaird.liquorlog.R.id.qtySpinner;

public class EditDrinkActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_drink2);
        ...
        if(extras == null) {
            ...
            measure = extras.getString("measure");
            ingredient = extras.getString("ingredient");
            msg = extras.getString("msg");
        }*/

        //if (appInfo.savedDrinks.get(mydrink) != null) {
        // DrinkRecipe displayedDrink = appInfo.savedDrinks.get(mydrink);
        //String drinkName = displayedDrink.getName();
       /* EditText editName = (EditText) findViewById(editName1);
        //editingName.setText(displayedDrink.getName());
        //editName.setText(drinkName);

        EditText editMsg = (EditText) findViewById(messageEnter);
        //editMsg.setText(msg);

        //Spinner editQty = (Spinner) findViewById(qtySpinner);
        //editQty.set
        //}
    ...
    public void saveDrink(View v)
    {
        ...
        toast.show();
        Intent intent = new Intent(EditDrinkActivity2.this, MainActivity.class);
