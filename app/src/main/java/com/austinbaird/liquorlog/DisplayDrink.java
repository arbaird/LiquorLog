...
/*
    Activity to display a drink recipe
 */
public class DisplayDrink extends AppCompatActivity
{
    ...
    //the entire string for an ingredient, i.e "1 OZ of rum"
    String total;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //attach adapter to aList
        aa = new MyAdapter(this, R.layout.list_element_display, aList);
        ...
        //set up sounds for this activity
    ...
    protected void onResume()
    {
        ...
        {
            //get values from ingredient
            qty = ingredients.get(i).getQty();
            measure = ingredients.get(i).getMeasure();
            ingredient = ingredients.get(i).getIngredient();

            //create a string that will be displayed on the screen and format it according to inputed values
        ...
        alertDialog.setMessage("A drink with this name already exists in your log.\nAdd this drink anyway?(Existing drink will remain)")
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        //if user is okay with duplicate names, save drink and increment downloads to
                        //track popularity
                        appInfo.addDrink(displayedDrink);
                        mp3.start();
                        Toast.makeText(getBaseContext(), "Drink Added!", Toast.LENGTH_SHORT).show();
